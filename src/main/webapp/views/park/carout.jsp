...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> 车辆管理<span class="c-gray en">&gt;</span>车辆出
    ...
    <form id="form-template-add" class="form form-horizontal" target="result" method="post" onsubmit="return false;">
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
                <input class="btn btn-primary" type="submit" id="btn_submit" value="车辆出库">
            </div>
        </div>
    </form>
</article>
